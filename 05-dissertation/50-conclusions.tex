...
I created a more optimal stack allocation policy, designing a heuristic to produce significant improvements to programs' memory use~(\ccref{sec:impl:optimised stack allocation,sec:eval:optimised stack allocation}).
