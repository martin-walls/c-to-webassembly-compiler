...
\usepackage[sortcites=true,language=UKenglish,subentry=true]{biblatex}
% Allow line breaks after lowercase and uppercase letters in URLs
% in bibliography
\setcounter{biburllcpenalty}{7000}
\setcounter{biburlucpenalty}{8000}
% Separator between items of an entryset
...
% Remove space before percent symbol for siunitx
...
\newlength{\abovefigurecaptionskip}
\setlength{\abovefigurecaptionskip}{\abovecaptionskip+0.5pt}
...
\renewcommand\fs@boxed{\def\@fs@cfont{\bfseries}\let\@fs@capt\floatc@plain% chktex 1
  ...
  \def\@fs@mid{\kern\abovefigurecaptionskip}%
...
\usepackage{footnote}{\makesavenoteenv{tabularx}}
...
% Environment to wrap EnumerateAlgorithm with lines
\NewDocumentEnvironment{Algorithm}{}
  {%
    \begingroup
...
\usepackage{newfloat}
\DeclareFloatingEnvironment[name=Algorithm]{AlgorithmFloat}
...
\ifCompileForWordCount % chktex 1
  ...
  \RenewDocumentCommand{\ccref}{m}{\textcolor{refcolor}{ref x}}
  \RenewDocumentCommand{\Ccref}{m}{\textcolor{refcolor}{ref x}}
  \RenewDocumentCommand{\ccrefrange}{mm}{\textcolor{refcolor}{refrange x to y}}
  \RenewDocumentCommand{\Ccrefrange}{mm}{\textcolor{refcolor}{refrange x to y}}
  \RenewDocumentCommand{\ccite}{O{}m}{}
\fi
