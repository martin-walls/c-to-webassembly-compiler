...
\footnotetext[1]{Word count computed by \mintinline{bash}{texcount -inc -total -sum}.}
\footnotetext[2]{Code line count computed by \mintinline{bash}{cloc . --by-file --force-lang=Rust,lalrpop --list-file=.cloc}.}
