...
\label{sec:prep:relooper algorithm}
...
I wrote the runtime environment in JavaScript \ccite{javascript}, using Node.js \ccite{nodejs}, which is necessary to interface with the WebAssembly binary.
...
I used the CLion IDE as my development environment, using the Intellij Rust plugin \ccite{intellij-rust-plugin}.
