...
\begin{Algorithm}{`Soupifying' the intermediate code.}{alg:soupify}
...
For every function in the \gls{ir}, the instructions are soupified and then \ccref{alg:relooper} (in \ccref{sec:prep:relooper algorithm}) is used to create a Relooper block.
