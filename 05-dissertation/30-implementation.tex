...
When each variable is allocated, it is allocated a register that maximally overlaps with already allocated variables, while avoiding those containing variables it clashes with.
...
\vspace{-1ex} % Make the summary fit on the bottom of the page below the table
