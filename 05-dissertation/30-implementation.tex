...
The grammar of the C language is mostly context-free, however the presence of typedef definitions make it context-sensitive \ccite[Section 5.10.3]{c-reference-manual}.
