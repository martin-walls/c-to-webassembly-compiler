...
- Memory manipulation functions -- load/store var of given type

- talk about naive var allocation strategy

- Int and vector encoding

- Used IdGenerator pattern again
\end{mrwComment}
...
Arguments are passed to the \CInline{main} function as an array of \CInline{char} pointers, plus the argument count.
