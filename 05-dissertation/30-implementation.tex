...
A \gls{vla} is when the array length is set at run-time by a variable.
To handle \glspl{vla}, an instruction is inserted to allocate space on the stack for it at run-time.
