...
\Indent{1}\Dirname{front_end} & Lexer, parser grammar, AST data structure. \\\hline
\Indent{1}\Dirname{middle_end} & IR data structures, definition of intermediate instructions. Converting AST to IR. \\\hline
