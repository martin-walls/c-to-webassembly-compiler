...
\Ccref{fig:comparing stack usage for case.c} shows the size of the stack over the execution of a program that converts a string to upper, lower, and camel case in turn.
